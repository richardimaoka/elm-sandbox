...
var $author$project$Main$tasksFromList = function (list) {
	return $elm$core$Array$fromList(list);
};
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{tasks: $author$project$Main$initTasks, title: 'my first task page'},
...
var $author$project$Main$findRecursive = F3(
	function (predicate, currentIndex, array) {
		var maybeIndex = function (currentValue) {
			return predicate(currentValue) ? $elm$core$Maybe$Just(currentIndex) : A3($author$project$Main$findRecursive, predicate, currentIndex + 1, array);
		};
		return A2(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$Main$codeCopyButton(codeString)
							])),
...
var $author$project$Main$tasksToList = function (tasks) {
	return $elm$core$Array$toList(tasks);
};
...
var $author$project$Main$main = $author$project$Main$main0;
