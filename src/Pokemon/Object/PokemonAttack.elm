...
fast object____ =
    Object.selectionForCompositeField "fast" [] object____ (identity >> Decode.nullable >> Decode.list >> Decode.nullable)
...
special :
    ...
    -> SelectionSet (Maybe (List (Maybe decodesTo))) Pokemon.Object.PokemonAttack
special object____ =
    Object.selectionForCompositeField "special" [] object____ (identity >> Decode.nullable >> Decode.list >> Decode.nullable)
